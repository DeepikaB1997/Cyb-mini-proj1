...
$( document ).ready(function() {
    ...
    var temp=0;
        ...
        success: function(result){
            ...
            $("#hum1").text(result.current.humidity).prepend("Humidity  :    ")
       ...
       $.ajax({
        ...
        success: function(result){
            ...
            $("#hum2").text(result.current.humidity).prepend("Humidity  :    ")
       ...
       $.ajax({
        ...
        success: function(result){
            ...
            $("#hum3").text(result.current.humidity).prepend("Humidity  :    ")
       ...
       $("#search").click(function(){
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                $("#hum5").text(result.current.humidity).prepend("Humidity  :    ")
